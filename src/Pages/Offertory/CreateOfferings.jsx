                ...
                <div className="space-y-4">
                    ...
                    <div className="flex justify-center gap-4">
                        ...
                        <button
                            ...
                            className={`px-4 py-2 text-white rounded ${selectedItem?.status === "Active"
                                    ? "bg-red-500 hover:bg-red-600"
                                    : "bg-green-600 hover:bg-green-700"
                                }`}
                        >
                            Yes, {selectedItem?.status === "Active"
                                ? "Inactivate"
                                : "Activate"}
                        </button>
